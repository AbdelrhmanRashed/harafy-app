            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <Button
                  ...
                  className="flex h-12 items-center gap-2 rounded-2xl bg-white px-6 font-bold text-emerald-600 hover:bg-emerald-50 shadow-lg cursor-pointer transition-all hover:scale-105"
                >
        ...
        <div className="flex flex-col gap-4">
          <Card className="rounded-3xl border-0 shadow-[0_2px_20px_rgb(0,0,0,0.04)] bg-white dark:bg-slate-900">
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div>
                <p className="text-sm font-semibold text-muted-foreground">إجمالي النقاط المشتراة</p>
                <p className="text-xl font-black text-foreground">0 نقطة</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-3xl border-0 shadow-[0_2px_20px_rgb(0,0,0,0.04)] bg-white dark:bg-slate-900">
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div>
                <p className="text-sm font-semibold text-muted-foreground">النقاط المستهلكة</p>
                <p className="text-xl font-black text-foreground">0 نقطة</p>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="rounded-3xl border-0 shadow-[0_2px_20px_rgb(0,0,0,0.04)]">
          <CardContent className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              سجل عمليات شحن واستخدام النقاط سيظهر هنا فور بدايتك.
            </p>
          </CardContent>
        </Card>
      </div>
