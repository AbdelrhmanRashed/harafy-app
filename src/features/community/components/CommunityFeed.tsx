...
const posts = [
{
  ...
  user: { name: "ليلى حسن" },
  role: "حرفي",
  subject:  "  ما هي أفضل الأدوات التي تستخدمونها لإدارة المهام في الفرق الصغيرة؟  ",
  content:"مرحباً جميعاً! أنا جديدة في عالم الحرفيين وأرغب في معرفة كيف تديرون مهامكم اليومية ومشاريعكم. هل تستخدمون تطبيقات معينة أو طرق تقليدية؟ أود سماع تجاربكم ونصائحكم حول هذا الموضوع!",
  likes: 12,
  comments: 3,
  createdAt: "منذ ساعة",
},
