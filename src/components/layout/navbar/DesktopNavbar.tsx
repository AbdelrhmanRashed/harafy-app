...
const DesktopNavbar = ({ role }: DesktopNavbarProps) => {
  return (
    <header className="bg-background border-border sticky top-0 z-50 hidden h-16 w-full items-center justify-between border-b px-6 font-sans shadow-sm md:flex">
